...
import { Play, Radio, Headphones, List, Newspaper, Menu, X, Search } from 'lucide-react';

const IHeartLanding = () => {
const [selectedLocation, setSelectedLocation] = useState('West Palm Beach, FL');
...
{ name: 'A Twist of History', color: 'bg-gradient-to-br from-teal-400 to-cyan-600' },
{ name: 'Aubrey O\'Day', color: 'bg-gradient-to-br from-yellow-600 to-gray-900' },
{ name: 'What Happened to Holly Bobo?', color: 'bg-gradient-to-br from-gray-600 to-gray-800' }
];
  ...
  <div className="flex justify-between items-center h-16">
    ...
    <div className="flex items-center flex-shrink-0">
      <div className="flex items-center space-x-2">
        ...
        <span className="hidden sm:inline bg-red-600 text-white text-xs px-2 py-1 rounded">Upgrade</span>
      </div>
    </div>
    
    {/* Desktop Navigation */}
    <nav className="hidden lg:flex space-x-6 xl:space-x-8">
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">For You</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">Your Library</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">Live Radio</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">Podcasts</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">Artist Radio</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">Playlists</a>
      <a href="#" className="text-gray-700 hover:text-gray-900 text-sm">News</a>
    </nav>
  ...
  {mobileMenuOpen && (
    <div className="md:hidden border-t border-gray-200">
      <div className="px-2 pt-2 pb-3 space-y-1">
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">For You</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">Your Library</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">Live Radio</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">Podcasts</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">Artist Radio</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">Playlists</a>
        <a href="#" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 rounded-md">News</a>
        <div className="border-t border-gray-200 mt-2 pt-2">
          <span className="inline-block mx-3 my-2 bg-red-600 text-white text-xs px-3 py-1 rounded">Upgrade</span>
        </div>
      </div>
    </div>
  )}
...
<div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6">
  <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg text-center">
    ...
    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Live Radio</h3>
  </div>
  <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg text-center">
    <Headphones className="w-8 h-8 sm:w-12 sm:h-12 text-purple-600 mx-auto mb-2 sm:mb-4" />
    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Podcasts</h3>
  </div>
  <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg text-center">
    <List className="w-8 h-8 sm:w-12 sm:h-12 text-blue-600 mx-auto mb-2 sm:mb-4" />
    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">Playlists</h3>
  </div>
  <div className="bg-white rounded-lg p-4 sm:p-6 shadow-lg text-center">
    <Newspaper className="w-8 h-8 sm:w-12 sm:h-12 text-orange-600 mx-auto mb-2 sm:mb-4" />
    <h3 className="font-semibold text-gray-900 text-sm sm:text-base">News</h3>
  </div>
</div>
</section>
...
<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 space-y-4 sm:space-y-0">
  <div>
    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Live Radio</h2>
    <p className="text-gray-600 text-sm sm:text-base">The best live stations from around the country, any time, any place.</p>
  </div>
  <select
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
  {liveRadioStations.map((station, index) => (
    <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      <div className={`h-24 sm:h-32 ${station.color} flex items-center justify-center`}>
        <div className="text-white text-xl sm:text-2xl font-bold">{station.logo}</div>
      </div>
      <div className="p-3 sm:p-4">
        <h3 className="font-bold text-gray-900 mb-1 text-sm sm:text-base">{station.name}</h3>
        <p className="text-xs sm:text-sm text-gray-600">{station.subtitle}</p>
      </div>
    </div>
  ))}
</div>
...
<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 space-y-4 sm:space-y-0">
  <div>
    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Artist Radio</h2>
    <p className="text-gray-600 text-sm sm:text-base">Custom radio stations based off your favorite artists and bands.</p>
  </div>
...
<div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
  {artists.map((artist, index) => (
    <div key={index} className="text-center">
      ...
      <h3 className="font-semibold text-gray-900 text-sm sm:text-base">{artist.name}</h3>
    </div>
  ))}
</div>
</section>
...
<div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-8 space-y-4 sm:space-y-0">
  <div>
    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Podcasts</h2>
    <p className="text-gray-600 text-sm sm:text-base">Popular and exclusive podcasts in a variety of genres and topics.</p>
  </div>
  <button className="text-red-600 hover:text-red-700 font-semibold text-sm sm:text-base self-start sm:self-auto">
    View More Podcasts →
  </button>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
  {podcasts.map((podcast, index) => (
    <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
      <div className={`h-36 sm:h-48 ${podcast.color} flex items-center justify-center`}>
        <div className="text-white text-lg sm:text-xl font-bold text-center px-4">{podcast.name}</div>
      </div>
      <div className="p-3 sm:p-4">
        <h3 className="font-bold text-gray-900 text-sm sm:text-base">{podcast.name}</h3>
      </div>
    </div>
  ))}
</div>
